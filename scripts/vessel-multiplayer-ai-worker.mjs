...
const DEFAULT_BRIEF = [
  ...
  'Choose exactly one available brush. Current Stroke preserves the regular brush already selected for the session. Color Cycle Stroke is a moving linear contour. Color Cycle Shape is a solid bounded animated field. CC Fixed Dither is a bounded linear field with stable Sierra Lite texture and moving colour.',
