    ...
    layers: [{
      ...
      colorCycle: {
        ...
        brushState: {
          ...
          indexBuffer,
          gradientIdBuffer,
          gradientDefIdBuffer: new Array(SURFACE_SIZE * SURFACE_SIZE).fill(1),
          speedBuffer: new Array(SURFACE_SIZE * SURFACE_SIZE).fill(255),
          flowBuffer: new Array(SURFACE_SIZE * SURFACE_SIZE).fill(1),
          phaseBuffer: new Array(SURFACE_SIZE * SURFACE_SIZE).fill(0),
