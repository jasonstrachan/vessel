...
- **Rendering & color cycle** – `src/lib` hosts IndexBuffer/GradientPalette/ColorCycleAnimator and related rendering helpers. Canvas2D owns the main drawing surface, while WebGL-backed runtime paths support color-cycle playback/export.
