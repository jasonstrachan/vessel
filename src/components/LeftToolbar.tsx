...
const LeftToolbar = () => {
  ...
  return (
    <div className="w-7 flex flex-col pt-4 pb-0" style={{ backgroundColor: '#31313A' }}>
      {tools.map((tool) => (
        <button
          key={tool.id}
          onClick={() => setCurrentTool(tool.id)}
          title={tool.label}
          className={`w-7 h-32 min-h-[64px] mx-auto flex items-center justify-center bg-transparent hover:bg-gray-600 border-0 appearance-none outline-none overflow-hidden ${
