...
function createBaseState(): AppState {
  ...
  autosave: { isEnabled: false, hasUnsavedChanges: false, isRunning: false, interval: 30, fileBackup: { enabled: false, mode: 'single-file', fileHandle: null, directoryHandle: null } } as unknown,
