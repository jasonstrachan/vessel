...
export const buildDrawingCanvasRuntimeEffectsFromOrchestrationOptions = ({
  ...
  interactionRuntime: {
    ...
    setIsSpacePressed: orchestration.interactionRuntime.setIsSpacePressed,
    setCursorStyleRef: orchestration.interactionRuntime.setCursorStyleRef,
    setShowBrushCursorRef: orchestration.interactionRuntime.setShowBrushCursorRef,
    panRef: orchestration.interactionRuntime.panRef,
