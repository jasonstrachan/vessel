...
export const repairLegacyColorCycleLayer = (
  layer: Layer,
  options: Pick<NormalizeColorCycleDocumentStateOptions, 'decodeSerializedBrushStateBuffers'> = {},
): ColorCycleLegacyRepairResult => {
  const documentStateResult = normalizeColorCycleLayerDocumentState(layer, options);
