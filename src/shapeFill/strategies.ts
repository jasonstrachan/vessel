...
const strategyMap: Record<ShapeFillId, FillStrategy> = {
  ...
  noise: {
    ...
    defaults: {
      ...
      noiseThreshold: getParameterDefault('noiseThreshold'),
    ...
    ui: [
      ...
      },
      {
        ...
        max: 240,
        step: 1,
        default: getParameterDefault('noiseScale'),
      },
      {
        key: 'noiseThreshold',
        type: 'number',
        ...
        max: 1,
        step: 0.01,
        default: getParameterDefault('noiseThreshold'),
      },
      {
        key: 'noiseContrast',
        type: 'number',
        ...
        max: 1,
        step: 0.01,
        default: getParameterDefault('noiseContrast'),
      },
      {
        key: 'noiseOctaves',
        type: 'number',
        ...
        max: 6,
        step: 1,
        default: getParameterDefault('noiseOctaves'),
      },
      {
        key: 'thickness',
        type: 'number',
