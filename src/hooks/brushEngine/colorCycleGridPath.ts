...
type OrthogonalPathResult = { pathPoints: GridSnapPoint[]; finalAxis: OrthogonalAxis | null };
...
const resolveSegmentAxis = (
  from: GridSnapPoint, to: GridSnapPoint,
): OrthogonalAxis | null => {
...
const chooseOrthogonalAxes = (
  from: GridSnapPoint, to: GridSnapPoint, preferredAxis: OrthogonalAxis | null = null,
...
const rasterizeArcPoints = (
  center: GridSnapPoint, startPoint: GridSnapPoint, endPoint: GridSnapPoint, radius: number, clockwise: boolean,
): GridSnapPoint[] => {
